...
namespace Brainiac
{
    ...
    public class BTAsset : ScriptableObject
    {
        ...
        [SerializeField] [HideInInspector] private string m_serializedData;
        [SerializeField] private Rect m_canvasArea;
        [SerializeField] private List<AssetIDPair> m_subtrees;
        ...
        {
            get { return m_canvasArea; }
            set { m_canvasArea = value; }
        }
