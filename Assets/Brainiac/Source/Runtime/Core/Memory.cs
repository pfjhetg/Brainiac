...
namespace Brainiac
{
    ...
    public class Memory
    {
        ...
        [SerializeField] private MemoryType m_type;
        [SerializeField] private bool m_valueBool;
        [SerializeField] private int m_valueInteger;
        [SerializeField] private float m_valueFloat;
        [SerializeField] private string m_valueString;
        [SerializeField] private Vector2 m_valueVector2;
        [SerializeField] private Vector3 m_valueVector3;
        [SerializeField] private GameObject m_valueGameObject;
        [SerializeField] private UnityEngine.Object m_valueAsset;
