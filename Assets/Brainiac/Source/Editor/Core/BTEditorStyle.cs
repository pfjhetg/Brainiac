...
namespace BrainiacEditor
{
    ...
    public static class BTEditorStyle
    {
        ...
        {
            get { return m_arrowUp; }
        }

        public static Texture ArrowDown
        {
            get { return m_arrowDown; }
        }
        ...
        {
            get { return m_regionBackground; }
        }

        public static BTEditorTreeLayout TreeLayout
        {
            get { return (BTEditorTreeLayout) EditorPrefs.GetInt("Brainiac.Editor.TreeLayout", (int) BTEditorTreeLayout.Free); }
            set { EditorPrefs.SetInt("Brainiac.Editor.TreeLayout", (int) value); }
        }
