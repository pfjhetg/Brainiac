...
namespace BrainiacEditor
{
    ...
    public class BTNavigationHistory : ISerializationCallbackReceiver
    {
        ...
        [SerializeField] private string m_serializedHistory;

        [NonSerialized] private bool m_needRefresh;

        private List<Brainiac.Tuple<string, BehaviourTree>> m_history;
        ...
        {
            m_history = new List<Brainiac.Tuple<string, BehaviourTree>>();
        ...
        {
            m_history.Add(new Brainiac.Tuple<string, BehaviourTree>(AssetDatabase.GetAssetPath(asset), instance));
            AddRecentFile(asset);
            SaveRecentFiles();
        }
        ...
        public void DiscardInstances()
        {
            ...
            {
                m_history[i] = new Brainiac.Tuple<string, BehaviourTree>(m_history[i].Item1, null);
            }
        }
